...
class GCS():
    def __init__(self):
        ...
        self.root.title('HAWK Ground Control Station')
        ...
        self.config_button = tk.Button(self.button_frame, text = 'Configuration', command = ins_link.send_config)
